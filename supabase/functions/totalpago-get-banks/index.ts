// File: supabase/functions/totalpago-get-banks/index.ts

import { serve } from 'https://deno.land/std@0.168.0/http/server.ts';

const TOTALPAGO_API_URL = 'https://www.totalpago.net/WSPasarela/service.svc/WM_fcn_CuentasBancariasPost';
